...
public class Problem10 {
    ...
    try {
      ...
      int[][] bots = new int[1000][2], instructions = new int[1000][2];
      while (input.hasNext()) {
      ...
      while (! queue.isEmpty()) {
        ...
        if (Math.max(givingBot[0], givingBot[1]) == 61 && Math.min(givingBot[0], givingBot[1]) == 17) {
